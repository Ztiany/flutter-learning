...
class LifecycleSecondPage extends StatefulWidget {
  LifecycleSecondPage({Key key}) : super(key: key);

  _LifecycleSecondPageState createState() => _LifecycleSecondPageState();
}
...
class _LifecycleSecondPageState extends State<LifecycleSecondPage> {
  ...
  */
  ...
  @override
  void didUpdateWidget(LifecycleSecondPage oldWidget) {
