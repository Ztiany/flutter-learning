...
在Flutter中，我们可以使用Navigator在页面之间跳转。下面展示的是基本路由的使用方法。
 */

Widget buildBaseRouterWidget() => _FirstScreen();
...
class _FirstScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text('Navigation-First Screen'),
      ),
      body: new Center(
...
class _SecondScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Navigation-Second Screen"),
      ),
      body: new Center(
        child: new RaisedButton(
          onPressed: () {
